  ...
  return (
    <Popover>
      <PopoverTrigger asChild>
        <Badge variant="outline" className="text-xs h-auto py-0.5 px-2 border-purple-500/50 text-purple-700 dark:text-purple-400 bg-purple-500/10 hover:bg-purple-500/20 flex items-center gap-1 cursor-pointer">
