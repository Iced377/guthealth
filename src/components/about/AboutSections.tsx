...
export function HeroSection({
  ...
  const featureLabelOpacity = useTransform(
    scrollYProgress,
    [0.46, 0.64],
    [0, 1]
  );
  ...
  const rightStatementOpacity = useTransform(
    scrollYProgress,
    [0.84, 0.96],
    [0, 1]
  );
  ...
  return (
    <section
      ref={heroRef}
      className="relative h-[200dvh] w-full snap-start snap-always landing-snap z-50 isolate"
    >
      <div className="sticky top-0 h-[100dvh] w-full flex items-start lg:items-center justify-center px-6 pt-[calc(env(safe-area-inset-top)+96px)] lg:pt-0 z-50">
        ...
        >
          ...
          >
            <div className="text-sm font-semibold tracking-widest text-slate-700">
              ★★★★★
            </div>
            <div className="text-lg font-semibold mt-2">
              Smart, Simple and Helpful
            </div>
            <div className="text-xs text-slate-500 mt-1">
              Feb 17, 2026 · Zaid Barakat
            </div>
            <p className="text-sm text-slate-700 mt-3 leading-relaxed">
              Gut Check is honestly one of the most useful health apps I’ve
              tried. It actually helps connect the dots between what I eat and
              how I feel.
            </p>
          </motion.div>
        ...
        >
          ...
          >
            GutCheck.
            <br />
            <span className="text-4xl sm:text-6xl lg:text-7xl text-emerald-300 drop-shadow-[0_12px_35px_rgba(0,0,0,0.6)]">
              Know your body.
            </span>
          </motion.h1>
        ...
        >
          ...
          >
            GutCheck.
            <br />
            <span className="text-3xl sm:text-4xl text-emerald-300 drop-shadow-[0_12px_30px_rgba(0,0,0,0.6)]">
              Know your body.
            </span>
          </motion.h1>
        ...
        >
          <div className="hidden lg:block">
            <motion.div
              ...
              className="absolute left-[5%] top-[14%] text-white"
            >
            ...
            <motion.div
              style={{ opacity: feature1Opacity, y: feature1Y, x: feature1X }}
              className="absolute left-[5%] top-[26%] text-white text-lg font-semibold drop-shadow-[0_16px_35px_rgba(0,0,0,0.8)]"
            >
              ★ Macros
            </motion.div>
            <motion.div
              style={{ opacity: feature2Opacity, y: feature2Y, x: feature2X }}
              className="absolute left-[9%] top-[36%] text-white text-lg font-semibold drop-shadow-[0_16px_35px_rgba(0,0,0,0.8)]"
            >
              ★ Fiber
            </motion.div>
            <motion.div
              style={{ opacity: feature3Opacity, y: feature3Y, x: feature3X }}
              className="absolute left-[3%] top-[46%] text-white text-lg font-semibold drop-shadow-[0_16px_35px_rgba(0,0,0,0.8)]"
            >
              ★ FODMAP
            </motion.div>
            <motion.div
              style={{ opacity: feature4Opacity, y: feature4Y, x: feature4X }}
              className="absolute left-[10%] top-[56%] text-white text-lg font-semibold drop-shadow-[0_16px_35px_rgba(0,0,0,0.8)]"
            >
              ★ KETO
            </motion.div>
            <motion.div
              style={{ opacity: feature5Opacity, y: feature5Y, x: feature5X }}
              className="absolute left-[4%] top-[68%] text-white text-lg font-semibold drop-shadow-[0_16px_35px_rgba(0,0,0,0.8)]"
            >
              ★ Glycemic Index
            </motion.div>
            <motion.div
              style={{ opacity: feature6Opacity, y: feature6Y, x: feature6X }}
              className="absolute left-[12%] top-[80%] text-white text-lg font-semibold drop-shadow-[0_16px_35px_rgba(0,0,0,0.8)]"
            >
              ★ Intermittent Fast & More
            </motion.div>

            <motion.div
              style={{ opacity: appleOpacity, y: appleY, scale: appleScale }}
              className="absolute left-1/2 bottom-[16%] -translate-x-1/2 text-white"
            >
              <div className="absolute -inset-6 -z-10 rounded-full bg-black/40 blur-3xl" />
              <div className="flex flex-col items-center gap-2 text-lg font-semibold drop-shadow-[0_14px_30px_rgba(0,0,0,0.8)]">
                <Image
                  src="/Apple Store DL.png"
                  alt="Apple Health"
                  width={180}
                  height={56}
            ...
            <motion.div
              style={{
                opacity: rightStatementOpacity,
                y: rightStatementY,
                x: rightStatementX,
              }}
              className="absolute right-[4%] top-[14%] max-w-[320px] text-white text-right"
            >
              <div className="absolute -inset-6 -z-10 rounded-full bg-black/40 blur-3xl" />
              <h3 className="text-2xl font-semibold leading-tight drop-shadow-[0_18px_40px_rgba(0,0,0,0.8)]">
                Simply Describe your Meal or Snap it, and GutCheck will do the
                rest
              </h3>
            </motion.div>
          </div>
          ...
          <div className="lg:hidden absolute inset-x-0 top-[48%] pb-[max(env(safe-area-inset-bottom),16px)] flex flex-col items-center gap-4 px-6 text-center text-white">
            <motion.div
              style={{ opacity: featureLabelOpacity, y: featureLabelY }}
            >
            ...
            <div className="grid grid-cols-2 gap-x-5 gap-y-2.5 text-base font-semibold drop-shadow-[0_10px_25px_rgba(0,0,0,0.8)]">
              ...
              <motion.div style={{ opacity: feature5Opacity, y: feature5Y }}>
                ★ Glycemic Index
              </motion.div>
              <motion.div style={{ opacity: feature6Opacity, y: feature6Y }}>
                ★ Intermittent Fast & More
              </motion.div>
            </div>
            <motion.div
              style={{ opacity: appleOpacity, y: appleY }}
              className="flex flex-col items-center gap-1.5 text-sm font-semibold drop-shadow-[0_12px_25px_rgba(0,0,0,0.8)]"
            >
              <Image
                src="/Apple Store DL.png"
                alt="Apple Health"
            ...
            <motion.div
              style={{ opacity: rightStatementOpacity, y: rightStatementY }}
              className="text-lg font-semibold drop-shadow-[0_14px_30px_rgba(0,0,0,0.8)] max-w-xs"
            >
              Simply Describe your Meal or Snap it, and GutCheck will do the
              rest
            </motion.div>
      ...
      <div
        className="h-[100dvh] snap-start snap-always landing-snap"
        aria-hidden="true"
      />
    </section>
  );
...
export function ProblemSection({
  ...
  return (
    <section
      ref={containerRef}
      className="relative h-[300dvh] bg-background z-0 snap-start snap-always landing-snap"
    >
      <div className="sticky top-0 h-[100dvh] w-full flex flex-col items-center pt-16 sm:pt-24 px-4 overflow-hidden z-0">
        ...
        <div className="text-center mb-4 sm:mb-8 space-y-3 max-w-3xl shrink-0 bg-background/95 backdrop-blur-xl border border-white/10 p-5 sm:p-6 rounded-[2rem] shadow-2xl z-0 landing-card landing-wide">
          ...
          <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed hidden sm:block">
            Traditional food logging hasn't changed in years. It's demanding,
            vaguely accurate, and often demotivating.
          </p>
  ...
  return (
    <section className="relative bg-foreground text-background py-24 px-4 snap-start snap-always landing-snap">
      <div className="container mx-auto max-w-sm sm:max-w-md relative landing-wide">
        ...
        {/* Stacking Cards */}
        <div className="space-y-[80dvh] pb-[50dvh]">
          <StoryCard
...
function StoryCard({
  ...
  return (
    <div
      className={cn(
        "sticky min-h-[50dvh] flex flex-col justify-start pt-12 p-8 rounded-3xl border border-white/10 shadow-2xl transition-transform origin-top snap-start snap-always landing-card",
        highlight
    ...
    >
      ...
      <p className="text-2xl sm:text-3xl opacity-90 leading-relaxed">
        {subtitle}
      </p>
    </div>
  );
...
function FeatureItem({
  ...
  return (
    <div
      ref={ref}
      className={cn(
        "flex flex-col md:flex-row items-center gap-12 landing-wide",
      ...
      <motion.div
        ...
        className={cn(
          ...
          videoSrc
            ...
            : "aspect-video bg-muted/30 border border-dashed border-muted-foreground/30"
        )}
      >
        {videoSrc ? (
  ...
  const securityItems = [
    {
      ...
      description:
        "We use Google's advanced reCAPTCHA to protect our app from spam and abuse without interrupting your experience.",
      Icon: ShieldCheck,
    },
    {
      title: "Google Authentication",
      description:
        "Secure user management powered by Google's robust authentication system, ensuring your account access is safe.",
      Icon: Lock,
    },
    {
    ...
    },
    {
      ...
      description:
        "App Check helps protect our backend resources from abuse by ensuring requests originate from your authentic app instances.",
      Icon: ShieldCheck,
    },
    {
      title: "Premium & Secure DNS",
      description:
        "Utilizing premium DNS services with enhanced security features like DDoS protection and DNSSEC for resilient and secure access.",
      Icon: Network,
    },
    {
      title: "Firestore Security Rules",
      description:
        "Robust server-side rules strictly control data access, ensuring you can only access your own information.",
      Icon: FileLock2,
    },
    {
      title: "Principle of Least Privilege",
      description:
        "Our systems are designed to ensure components only have access to the resources necessary for their function.",
      Icon: DatabaseZap,
    },
    {
      title: "Secure Cloud Infrastructure",
      description:
        "Leveraging Google Cloud Platform's secure and reliable infrastructure for hosting and data storage.",
      Icon: Server,
    },
    {
      title: "Total Privacy Control",
      description:
        "Your data is yours. Export it or delete it entirely at any time. We are transparent about what we store.",
      Icon: Eye,
    },
  ];
    ...
    <ScrollSection className="bg-muted/10">
      ...
      <div className="container mx-auto px-4 mt-20 text-center space-y-4">
        <p className="text-muted-foreground/60 text-sm max-w-2xl mx-auto border-t border-border/20 pt-8">
          &copy; 2026 GutCheck. All Rights Reserved. This app is a
          non-commercial project intended for informational purposes only and
